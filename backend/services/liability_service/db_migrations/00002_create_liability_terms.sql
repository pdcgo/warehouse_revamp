...
CREATE TABLE liability_terms (
    ...
    CONSTRAINT liability_terms_no_self CHECK (team_id <> counterparty_id),
    CONSTRAINT liability_terms_non_negative CHECK (
...
CREATE UNIQUE INDEX liability_terms_pair_idx
    ON liability_terms (team_id, counterparty_id);
-- +goose StatementEnd

-- +goose Down
-- +goose StatementBegin
DROP TABLE liability_terms;
-- +goose StatementEnd
