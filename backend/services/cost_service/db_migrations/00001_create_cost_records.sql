...
CREATE TABLE cost_records (
    ...
    -- CostKind as its enum NUMBER. Mapped in the handler, not by a DB CHECK IN-list (cf. #80): proto
...
CREATE INDEX cost_records_team_period_idx
    ON cost_records (team_id, occurred_at DESC, id DESC)
