...
func (s *Service) CostVoid(
	ctx context.Context,
	req *connect.Request[costv1.CostVoidRequest],
) (*connect.Response[costv1.CostVoidResponse], error) {
	...
	return connect.NewResponse(&costv1.CostVoidResponse{Cost: costToProto(&row)}), nil
}
