...
import (
	...
	cost_service_models "github.com/pdcgo/warehouse_revamp/backend/services/cost_service/cost_service_models"
)

func aCost() cost_service_models.CostRecord {
	return cost_service_models.CostRecord{
		TeamID:     2,
		Kind:       2, // PAYROLL
		Amount:     12_000_000,
...
func TestCostRecord_RoundTrips(t *testing.T) {
	db := san_testdb.DB(t)
	...
	var back cost_service_models.CostRecord
...
func TestCostRecord_RefusesANonPositiveAmount(t *testing.T) {
	db := san_testdb.DB(t)
