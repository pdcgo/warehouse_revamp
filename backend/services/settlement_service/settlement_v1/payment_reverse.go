...
// SettlementPaymentReverse undoes a confirmation made in error (#188).
//
...
func (s *Service) SettlementPaymentReverse(
	ctx context.Context,
	req *connect.Request[settlementv1.SettlementPaymentReverseRequest],
) (*connect.Response[settlementv1.SettlementPaymentReverseResponse], error) {
	...
	return connect.NewResponse(&settlementv1.SettlementPaymentReverseResponse{
