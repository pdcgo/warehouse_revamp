...
// SettlementPaymentRecord is PHASE ONE (#188): the payer says they paid.
//
...
func (s *Service) SettlementPaymentRecord(
	ctx context.Context,
	req *connect.Request[settlementv1.SettlementPaymentRecordRequest],
) (*connect.Response[settlementv1.SettlementPaymentRecordResponse], error) {
	...
	payment := settlement_service_models.SettlementPayment{
	...
	return connect.NewResponse(&settlementv1.SettlementPaymentRecordResponse{
