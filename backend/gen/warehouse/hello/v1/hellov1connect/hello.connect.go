...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/pdcgo/warehouse_revamp/backend/gen/warehouse/hello/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	HelloServiceName = "warehouse.hello.v1.HelloService"
)
...
const (
	...
	HelloServiceSayHelloProcedure = "/warehouse.hello.v1.HelloService/SayHello"
)

// HelloServiceClient is a client for the warehouse.hello.v1.HelloService service.
type HelloServiceClient interface {
	SayHello(context.Context, *connect.Request[v1.SayHelloRequest]) (*connect.Response[v1.SayHelloResponse], error)
}

// NewHelloServiceClient constructs a client for the warehouse.hello.v1.HelloService service. By
...
func NewHelloServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HelloServiceClient {
	...
	helloServiceMethods := v1.File_warehouse_hello_v1_hello_proto.Services().ByName("HelloService").Methods()
...
// SayHello calls warehouse.hello.v1.HelloService.SayHello.
...
// HelloServiceHandler is an implementation of the warehouse.hello.v1.HelloService service.
...
func NewHelloServiceHandler(svc HelloServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/warehouse.hello.v1.HelloService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHelloServiceHandler) SayHello(context.Context, *connect.Request[v1.SayHelloRequest]) (*connect.Response[v1.SayHelloResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("warehouse.hello.v1.HelloService.SayHello is not implemented"))
}
