...
[project_development_workflow.md](../../docs/requirements/project_development_workflow.md) is **one
...
Siblings: [development_level](../../docs/requirements/development_level.md) (its nearest neighbour, and
[the overlap is real](#critique)) · [architectures/architecture_context](architectures/architecture_context_clarity.md).
...
| [docs/faq/workflow.md](../../docs/faq/workflow.md) | the same rule as a **how-to**, with the `gh` commands | explains, never decides |
...
same recommendation I made for [`architectures/`](architectures/architecture_context_clarity.md) and for the
...
1. **Fold into [development_level.md](../../docs/requirements/development_level.md), or keep separate?**
...
| [docs/faq/workflow.md](../../docs/faq/workflow.md) | *"Plus the Playwright spec **for the work in hand — not the whole suite**, CI covers the rest."* |
