...
The roles I read out of [user_context.md](../../docs/requirements/user_context.md), and what naming them
...
Siblings: [business_level](business_level_clarity.md) · [stock_context](stock_context_clarity.md) ·
[order_context](order_context_clarity.md) · [balance_context](balance_context_clarity.md).
...
[order_context](../../docs/requirements/order_context.md) says records orders by hand. *(§2)*
...
| set a debt threshold | *"team owner"* | ✅ the word has a definition — whose owner is open in [balance_context](balance_context_clarity.md#question) |
...
[business_level_clarity → a team is liable for records it does not solely control](business_level_clarity.md#a-team-is-liable-for-records-it-does-not-solely-control).
