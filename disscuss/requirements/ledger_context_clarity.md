...
What I read out of [ledger_context.md](../../docs/requirements/ledger_context.md), and what is still open.
...
Siblings: [balance_context](balance_context_clarity.md) · [order_context](order_context_clarity.md) ·
[architectures/architecture_context](architectures/architecture_context_clarity.md) ·
[business_level](business_level_clarity.md) · [stock_context](stock_context_clarity.md) ·
[product_context](product_context_clarity.md).
...
[balance_context Q2](balance_context_clarity.md#question). `ledger_context.md` can only say the ledger does
not do it.
...
is what makes
[one-book-for-all-money](architectures/architecture_context_clarity.md#one-book-for-all-money) a rule
...
1. **Where does the Debt Threshold gate live, and does it BLOCK or WARN?**
   [balance_context.md](../../docs/requirements/balance_context.md) says *"prevent"*, which a projection
   ...
   *(⚠ The decision belongs in [balance_context](balance_context_clarity.md#question) — asked here only
...
[one-book-for-all-money](architectures/architecture_context_clarity.md#one-book-for-all-money) — I would
...
- **No currency, precision or rounding statement.** Carried from
  [balance_context Critique 8](balance_context_clarity.md#critique), and it lands here hardest: the log rows
