...
`# Statistic Design.` item 1: *"we rely [event_library](./event_library.md) for processing event."*
...
ledger. [stock_design.md](stock_design.md) has since put `StockMutation` in **Accept** and named that
...
**Sibling docs:** [stock_design.md](stock_design.md) and [event_library.md](event_library.md) have their
