...
## Implementing The Ledger from [Mutation & Ledger](./mutation_and_ledger.md) on Stocks.
...
## Implementing The Ledger from [Mutation & Ledger](./mutation_and_ledger.md) on Placements.
