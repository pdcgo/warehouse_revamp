...
**106 open questions across 18 files.** The seven below are shown; **99 are not** — they are not
...
| [business/settlement/context_clarify.md](business/settlement/context_clarify.md#question) | 7 | ▼ the architecture is settled by **withdrawal** — the analytic pointer was deleted as immature, leaving the write path as the only design standing |
