...
**116 open questions across 20 files.** The seven below are shown; **109 are not** — they are not
...
## Where the other 106 are

⚠ **This table is every file's FULL open count, not the residue** — the seven above are rolled up
*from* these files, so the column sums to **113**, the whole set, not to 106. Previous rounds left
