...
**132 open questions across 24 files.** The seven below are shown; **125 are not** — they are not
...
| [business/order/order_return_clarify.md](business/order/order_return_clarify.md#question) | 3 | 🆕 the return warehouse: per shop or per team (the platform prints the return address per shop) · frozen on the order · which warehouses a team may name |
