...
**111 open questions across 21 files.** The seven below are shown; **104 are not** — they are not
...
> [`event/library.md`](technical/event/library.md) says *"supported is: Google Pub/Sub, local
...
| [technical/event_architecture/context_clarify.md](technical/event_architecture/context_clarify.md#question) | 4 | 🆕 the doc is 3 lines. One broker or an abstraction · push or pull · **archive now or lose the history** · does this supersede `event/library.md` |
...
| [technical/event/library_clarify.md](technical/event/library_clarify.md#question) | 2 | |
