...
The rules I read out of [business_level.md](./business_level.md), and what it
...
> — [user_context.md](./user/context.md) makes it a **role inside the selling
...
undecided ([product_context Question 1](./product/context_clarify.md#question)). Two identical units can sit
...
[reserved-stock-is-never-shared](./product/context_clarify.md#reserved-stock-is-never-shared) and
[shared-lock-stops-sharing-entirely](./product/context_clarify.md#shared-lock-stops-sharing-entirely).
...
>
> [`balance_context.md`](./balance/context.md) §What Things That Affect The Team
...
[balance_context Contradiction](./balance/context_clarify.md#contradiction).
