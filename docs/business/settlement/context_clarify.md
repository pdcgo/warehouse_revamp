...
- ➡ **MOVED — *how is a missing settlement account FOUND?* is now [order: a-lost-publish-is-not-tracked-on-the-order](../order/context_decision.md#a-lost-publish-is-not-tracked-on-the-order).**
