...
Critique, questions and warnings about [event_library.md](./library.md). That doc is yours; this
...
2. **Outbox, or reconcile-as-recovery?** The same question
   [`stock_design_clarity.md`](../stock/design_clarify.md) asks of the three stock flows. One answer settles
   both.
