...
[architecture_context.md](./context.md), what it
...
> decides the COGS amount* — [ledger is downstream projection](../../business/ledger/context.md)
...
[user_context](../../business/user/context_clarify.md) ·
[systems/systems_product_context](../../business/product/systems_clarify.md).
...
[ledger is downstream projection](../../business/ledger/context.md) adds is that the journal is
...
figure. *(derived from [batch-fifo-pricing](../../business/product/context_clarify.md#batch-fifo-pricing) plus the
settlement)*
...
[balance_context.md:16](../../business/balance/context.md) says *"two mirrored row"*, and a gate
...
| 15 | receiving (restock and return), fee input | `inventory/context.md:8-40` | `inventory_service` | one flow, one screen, one person at the door |
