...
import { InvoicePayableAdminPaidRequestPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Invoices/PayableAdmin/PaidRequest",
  component: InvoicePayableAdminPaidRequestPage,
  parameters: { docs: { description: { component: description } } },
  args: { requests: PAYMENTS },
} satisfies Meta<typeof InvoicePayableAdminPaidRequestPage>;
