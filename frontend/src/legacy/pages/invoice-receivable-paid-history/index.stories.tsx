...
import { InvoiceReceivablePaidHistoryPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Invoices/Receivable/PaidHistory",
  component: InvoiceReceivablePaidHistoryPage,
  parameters: { docs: { description: { component: description } } },
  args: { payments: PAYMENTS },
} satisfies Meta<typeof InvoiceReceivablePaidHistoryPage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("paid-history-screen")).toHaveAttribute("data-direction", "receivable");
  },
};
