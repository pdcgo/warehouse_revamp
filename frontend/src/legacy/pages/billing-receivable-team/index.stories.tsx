...
import { BillingReceivableTeamPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Billing/Receivable/Team",
  component: BillingReceivableTeamPage,
  parameters: { docs: { description: { component: description } } },
  args: { teams: TEAM_BALANCES },
} satisfies Meta<typeof BillingReceivableTeamPage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("billing-team-screen")).toHaveAttribute("data-direction", "receivable");
  },
};
