...
import { AccountingAdsDailyPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Accounting/Ads/Daily",
  component: AccountingAdsDailyPage,
  parameters: { docs: { description: { component: description } } },
  args: { rows: AD_SPEND },
} satisfies Meta<typeof AccountingAdsDailyPage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("ad-spend-screen")).toHaveAttribute("data-grouping", "day");
  },
};
