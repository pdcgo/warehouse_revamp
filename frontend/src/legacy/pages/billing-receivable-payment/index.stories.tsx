...
import { BillingReceivablePaymentPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Billing/Receivable/Payment",
  component: BillingReceivablePaymentPage,
  parameters: { docs: { description: { component: description } } },
  args: { payments: PAYMENTS },
} satisfies Meta<typeof BillingReceivablePaymentPage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("billing-payment-screen")).toHaveAttribute("data-direction", "receivable");
  },
};
