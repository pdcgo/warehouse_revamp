...
import { InvoiceReceivablePaidRequestPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Invoices/Receivable/PaidRequest",
  component: InvoiceReceivablePaidRequestPage,
  parameters: { docs: { description: { component: description } } },
  args: { requests: PAYMENTS },
} satisfies Meta<typeof InvoiceReceivablePaidRequestPage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("paid-request-screen")).toHaveAttribute("data-direction", "receivable");
  },
};
