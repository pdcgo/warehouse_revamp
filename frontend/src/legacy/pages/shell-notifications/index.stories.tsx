...
import { NotificationSectionShell, description } from "./index";

const meta = {
  title: "Legacy/Pages/Shells/Notifications",
  component: NotificationSectionShell,
  parameters: { docs: { description: { component: description } } },
  args: { children: <Text data-testid="child">The selected screen renders here.</Text> },
} satisfies Meta<typeof NotificationSectionShell>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("section-shell")).toHaveAttribute("data-section", "Notifications");
...
export const SecondTabSelected: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("nav-tab-detail")).toHaveAttribute("aria-selected", "true");
  },
};
