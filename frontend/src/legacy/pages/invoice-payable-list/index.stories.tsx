...
import { InvoicePayableListPage, description } from "./index";

const ROWS = INVOICES.filter((i) => i.direction === "payable");

const meta = {
  title: "Legacy/Pages/Invoices/Payable/List",
  component: InvoicePayableListPage,
  parameters: { docs: { description: { component: description } } },
  args: { invoices: ROWS },
} satisfies Meta<typeof InvoicePayableListPage>;
