...
import { AccountingExpenseSectionShell, description } from "./index";

const meta = {
  title: "Legacy/Pages/Shells/AccountingExpense",
  component: AccountingExpenseSectionShell,
  parameters: { docs: { description: { component: description } } },
  args: { children: <Text data-testid="child">The selected screen renders here.</Text> },
} satisfies Meta<typeof AccountingExpenseSectionShell>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("section-shell")).toHaveAttribute("data-section", "Expenses");
...
export const SecondTabSelected: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("nav-tab-overview")).toHaveAttribute("aria-selected", "true");
  },
};
