...
import { StatisticTeamPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Statistics/Team",
  component: StatisticTeamPage,
  parameters: { docs: { description: { component: description } } },
  args: { rows: METRICS },
} satisfies Meta<typeof StatisticTeamPage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("metric-screen")).toHaveAttribute("data-dimension", "Team");
