...
import { StatisticShopPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Statistics/Shop",
  component: StatisticShopPage,
  parameters: { docs: { description: { component: description } } },
  args: { rows: METRICS },
} satisfies Meta<typeof StatisticShopPage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("metric-screen")).toHaveAttribute("data-dimension", "Shop");
