...
import { StatisticProductPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Statistics/Product",
  component: StatisticProductPage,
  parameters: { docs: { description: { component: description } } },
  args: { rows: METRICS },
} satisfies Meta<typeof StatisticProductPage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("metric-screen")).toHaveAttribute("data-dimension", "Product");
