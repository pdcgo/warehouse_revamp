...
import { AccountingAdsShopPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Accounting/Ads/Shop",
  component: AccountingAdsShopPage,
  parameters: { docs: { description: { component: description } } },
  args: { rows: AD_SPEND },
} satisfies Meta<typeof AccountingAdsShopPage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("ad-spend-screen")).toHaveAttribute("data-grouping", "shop");
  },
};
