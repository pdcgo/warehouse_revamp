...
import { InvoiceReceivableSectionShell, description } from "./index";

const meta = {
  title: "Legacy/Pages/Shells/InvoicesReceivable",
  component: InvoiceReceivableSectionShell,
  parameters: { docs: { description: { component: description } } },
  args: { children: <Text data-testid="child">The selected screen renders here.</Text> },
} satisfies Meta<typeof InvoiceReceivableSectionShell>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("section-shell")).toHaveAttribute("data-section", "Receivable");
