...
import { StatisticSupplierPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Statistics/Supplier",
  component: StatisticSupplierPage,
  parameters: { docs: { description: { component: description } } },
  args: { rows: METRICS },
} satisfies Meta<typeof StatisticSupplierPage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("metric-screen")).toHaveAttribute("data-dimension", "Supplier");
