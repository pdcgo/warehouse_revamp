...
import { BillingReceivableTimelinePage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Billing/Receivable/Timeline",
  component: BillingReceivableTimelinePage,
  parameters: { docs: { description: { component: description } } },
  args: { counterparty: "CV Sinar Jaya", entries: LEDGER_ENTRIES },
} satisfies Meta<typeof BillingReceivableTimelinePage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("billing-timeline-screen")).toHaveAttribute("data-direction", "receivable");
  },
};
