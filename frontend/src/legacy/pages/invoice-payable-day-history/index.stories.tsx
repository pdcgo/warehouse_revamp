...
import { InvoicePayableDayHistoryPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Invoices/Payable/DayHistory",
  component: InvoicePayableDayHistoryPage,
  parameters: { docs: { description: { component: description } } },
  args: { days: DAY_TOTALS },
} satisfies Meta<typeof InvoicePayableDayHistoryPage>;
