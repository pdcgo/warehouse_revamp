...
import { InvoiceReceivableDayHistoryPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Invoices/Receivable/DayHistory",
  component: InvoiceReceivableDayHistoryPage,
  parameters: { docs: { description: { component: description } } },
  args: { days: DAY_TOTALS },
} satisfies Meta<typeof InvoiceReceivableDayHistoryPage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("day-history-screen")).toHaveAttribute("data-direction", "receivable");
  },
};
