...
import { StatisticCostPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Statistics/Cost",
  component: StatisticCostPage,
  parameters: { docs: { description: { component: description } } },
  args: { rows: METRICS },
} satisfies Meta<typeof StatisticCostPage>;
...
export const Default: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("metric-screen")).toHaveAttribute("data-dimension", "Cost centre");
