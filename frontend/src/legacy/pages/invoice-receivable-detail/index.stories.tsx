...
import { InvoiceReceivableDetailPage, description } from "./index";

const INVOICE = INVOICES.find((i) => i.direction === "receivable")!;

const meta = {
  title: "Legacy/Pages/Invoices/Receivable/Detail",
  component: InvoiceReceivableDetailPage,
  parameters: { docs: { description: { component: description } } },
  args: { invoice: INVOICE, lines: INVOICE_LINES, payments: PAYMENTS },
} satisfies Meta<typeof InvoiceReceivableDetailPage>;
...
export const OutstandingIsTheHeadline: Story = {
  play: async ({ canvasElement }) => {
    ...
    await expect(canvas.getByTestId("invoice-detail-screen")).toHaveAttribute("data-direction", "receivable");
  },
};
