...
import { InvoicePayablePaidHistoryPage, description } from "./index";

const meta = {
  title: "Legacy/Pages/Invoices/Payable/PaidHistory",
  component: InvoicePayablePaidHistoryPage,
  parameters: { docs: { description: { component: description } } },
  args: { payments: PAYMENTS },
} satisfies Meta<typeof InvoicePayablePaidHistoryPage>;
